      ...
      <Row>
        <Col lg={3} className="image-area">
          <Form.Control
            ...
            /* Bu form elemani file upload oldugu icin diger form elemanlari gibi formikle isi kolaylastiramiyoruz.
            name, onchange, ref( useRef hooku) kullanmak gerekti.*/
          />
          ...
          <Row>
            <Form.Group as={Col} md={4} lg={3} className="mb-3">
              ...
              <Form.Control
                type="text"
                /* name=""
                value=""      ==> Eski yontemde bu sekilde yapiyorken simdi formik kolaylık sagliyor
                onChange="" */
